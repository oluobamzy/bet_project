...
class PredictionTracker:
    ...
    def record_prediction(self, match_id: str, home_team: str, away_team: str, 
                         predicted: str, confidence: float, league: str, match_date: str) -> None:
    ...
    def update_results(self, match_id: str, actual_result: str) -> bool:
    ...
    def generate_accuracy_report(self, days: int = 30, league: Optional[str] = None) -> Optional[Dict[str, Any]]:
        ...
        try:
            ...
            report = {
                ...
                "period_days": days,
                "league_filter": league if league else "",  # Ensure this is a string, not None
