...
class PredictionExplainer:
    ...
    def _load_model(self, league_name=""):
        ...
        if league_name:
            ...
            if not model_path.exists():
                logging.info(f"?? No specific model for {league_name}, using general model")
    ...
    def explain_prediction(self, fixture_data, league_name=""):
        """
        ...
        try:
            ...
            timestamp = fixture_data.get("date", "unknown")
